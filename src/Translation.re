...
let translateValue =
  ...
  let valueAccessPath =
    typeEnv
    |> TypeEnv.getModuleItemAccessPath(~config, ~name=resolvedNameOriginal);
...
let translateComponent =
  ...
  | Function(
    ...
    let valueAccessPath =
      typeEnv |> TypeEnv.getModuleItemAccessPath(~config, ~name="make");
    let componentAccessPath =
      typeEnv
      |> TypeEnv.getModuleItemAccessPath(
           ~component=true,
           ~config,
           ~name="component",
         );
