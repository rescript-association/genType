...
export const testArray: ([?number]) => [?number] = function _(Arg1) { const result = TypesBS.testArray(Arg1.map(function (x) { return (x == null ? undefined : x)})); return result.map(function (x) { return x}) };