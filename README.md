...
# MacOS
curl -L https://github.com/cristianoc/genType/releases/download/v0.22.0/gentype-macos.tar.gz | tar xz

# Linux
curl -L https://github.com/cristianoc/genType/releases/download/v0.22.0/gentype-linux.tar.gz | tar xz
```
