...
export const test: (_1:TypeParams2_items) => TypeParams2_items = TypeParams3BS.test;

export const test2: (_1:TypeParams2_items2) => TypeParams2_items2 = TypeParams3BS.test2;
