...
export const printEnumValue: (_1:withPayload) => void = function _(Arg1: any) { const result = VariantsWithPayloadBS.printEnumValue((typeof(Arg1) === 'object' ? [/* c */99, [Arg1.x, Arg1.y]] : $$toRE542320962[Arg1.toString()])); return result };
