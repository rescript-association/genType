...
export const testVariantWithPayloads: (_1:variantWithPayloads) => variantWithPayloads = function _(Arg1: any) { const result = EnumsWithPayloadBS.testVariantWithPayloads((typeof(Arg1) === 'object' ? (Arg1.tag==="B" ? CreateBucklescriptBlock.__(0, Arg1.value) :  Arg1.tag==="C" ? CreateBucklescriptBlock.__(1, Arg1.value) :  Arg1.tag==="D" ? CreateBucklescriptBlock.__(2, Arg1.value) :  CreateBucklescriptBlock.__(3, Arg1.value)) : $$toRE552311971[Arg1])); return (typeof(result) === 'object' ? (result[0]===0 ? {tag:"B", value:result[1]} :  result[0]===1 ? {tag:"C", value:result[1]} :  result[0]===2 ? {tag:"D", value:result[1]} :  {tag:"E", value:result[1]}) : $$toJS552311971[result]) };
