...
export const testVariantWithPayloads: (_1:variantWithPayloads) => variantWithPayloads = function _(Arg1: any) { const result = EnumsWithPayloadBS.testVariantWithPayloads((typeof(Arg1) === 'object' ? (Arg1.tag==="B" ? CreateBucklescriptBlock.__(0, [Arg1.value]) :  Arg1.tag==="C" ? CreateBucklescriptBlock.__(1, Arg1.value) :  Arg1.tag==="D" ? CreateBucklescriptBlock.__(2, [Arg1.value]) :  CreateBucklescriptBlock.__(3, Arg1.value)) : $$toRE552311971[Arg1])); return (typeof(result) === 'object' ? (result.tag===0 ? {tag:"B", value:result[0]} :  result.tag===1 ? {tag:"C", value:[result[0], result[1]]} :  result.tag===2 ? {tag:"D", value:result[0]} :  {tag:"E", value:[result[0], result[1], result[2]]}) : $$toJS552311971[result]) };
...
export const c: variantWithPayloads = (typeof(EnumsWithPayloadBS.c) === 'object' ? (EnumsWithPayloadBS.c.tag===0 ? {tag:"B", value:EnumsWithPayloadBS.c[0]} :  EnumsWithPayloadBS.c.tag===1 ? {tag:"C", value:[EnumsWithPayloadBS.c[0], EnumsWithPayloadBS.c[1]]} :  EnumsWithPayloadBS.c.tag===2 ? {tag:"D", value:EnumsWithPayloadBS.c[0]} :  {tag:"E", value:[EnumsWithPayloadBS.c[0], EnumsWithPayloadBS.c[1], EnumsWithPayloadBS.c[2]]}) : $$toJS552311971[EnumsWithPayloadBS.c]);

export const d: variantWithPayloads = (typeof(EnumsWithPayloadBS.d) === 'object' ? (EnumsWithPayloadBS.d.tag===0 ? {tag:"B", value:EnumsWithPayloadBS.d[0]} :  EnumsWithPayloadBS.d.tag===1 ? {tag:"C", value:[EnumsWithPayloadBS.d[0], EnumsWithPayloadBS.d[1]]} :  EnumsWithPayloadBS.d.tag===2 ? {tag:"D", value:EnumsWithPayloadBS.d[0]} :  {tag:"E", value:[EnumsWithPayloadBS.d[0], EnumsWithPayloadBS.d[1], EnumsWithPayloadBS.d[2]]}) : $$toJS552311971[EnumsWithPayloadBS.d]);
