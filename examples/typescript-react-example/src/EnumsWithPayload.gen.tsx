...
export const c: variantWithPayloads = (typeof(EnumsWithPayloadBS.c) === 'object' ? (EnumsWithPayloadBS.c.tag===0 ? {tag:"B", value:EnumsWithPayloadBS.c[0]} :  EnumsWithPayloadBS.c.tag===1 ? {tag:"C", value:EnumsWithPayloadBS.c[0]} :  EnumsWithPayloadBS.c.tag===2 ? {tag:"D", value:EnumsWithPayloadBS.c[0]} :  {tag:"E", value:EnumsWithPayloadBS.c[0]}) : $$toJS552311971[EnumsWithPayloadBS.c]);

export const d: variantWithPayloads = (typeof(EnumsWithPayloadBS.d) === 'object' ? (EnumsWithPayloadBS.d.tag===0 ? {tag:"B", value:EnumsWithPayloadBS.d[0]} :  EnumsWithPayloadBS.d.tag===1 ? {tag:"C", value:EnumsWithPayloadBS.d[0]} :  EnumsWithPayloadBS.d.tag===2 ? {tag:"D", value:EnumsWithPayloadBS.d[0]} :  {tag:"E", value:EnumsWithPayloadBS.d[0]}) : $$toJS552311971[EnumsWithPayloadBS.d]);
