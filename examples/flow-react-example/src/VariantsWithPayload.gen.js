...
export const testWithPayload: (withPayload) => withPayload = function _(Arg1: $any) {
...
export const printVariantWithPayload: (withPayload) => void = function _(Arg1: $any) {
...
export const testManyPayloads: (manyPayloads) => manyPayloads = function _(Arg1: $any) {
...
export const printManyPayloads: (manyPayloads) => void = function _(Arg1: $any) {
...
export const testSimpleVariant: (simpleVariant) => simpleVariant = function _(Arg1: $any) {
  const result = VariantsWithPayloadBS.testSimpleVariant($$toRE346759412[Arg1]);
  return $$toJS346759412[result]
};

export const testVariantWithPayloads: (variantWithPayloads) => variantWithPayloads = function _(Arg1: $any) {
...
export const printVariantWithPayloads: (variantWithPayloads) => void = function _(Arg1: $any) {
...
export const testVariant1Int: (variant1Int) => variant1Int = function _(Arg1: $any) {
  const result = VariantsWithPayloadBS.testVariant1Int(CreateBucklescriptBlock.__(0, [Arg1.value]));
  return {tag:"R", value:result[0]}
};

export const testVariant1Object: (variant1Object) => variant1Object = function _(Arg1: $any) {
