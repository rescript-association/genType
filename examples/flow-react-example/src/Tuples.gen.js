...
export const computeArea: ([number, number, ?number]) => number = function _(Arg1) {
  const result = TuplesBS.computeArea([Arg1[0], Arg1[1], (Arg1[2] == null ? undefined : Arg1[2])]);
  return result
};

export const computeAreaWithIdent: (coord) => number = function _(Arg1) {
...
export const coord2d: <T1,T2,T3>(T1, T2) => [T1, T2, ?T3] = function _<T1,T2,T3>(Arg1, Arg2) {
...
export const changeSecondAge: (couple) => couple = function _(Arg1) {
