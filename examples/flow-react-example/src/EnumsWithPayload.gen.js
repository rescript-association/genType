...
export const printManyPayloads: (manyPayloads) => void = function _(Arg1) { const result = EnumsWithPayloadBS.printManyPayloads((typeof(Arg1) === 'object' ? (Arg1.tag==="one" ? [/* one */5544550, Arg1.value] :  Arg1.tag==="two" ? [/* two */5795212, Arg1.value] :  [/* three */261117022, [Arg1.value.x, Arg1.value.y]]) : $$toRE1058613066[Arg1])); return result };
