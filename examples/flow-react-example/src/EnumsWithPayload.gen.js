...
export const testVariant1Object: (variant1Object) => variant1Object = function _(Arg1) { const result = EnumsWithPayloadBS.testVariant1Object(CreateBucklescriptBlock.__(0, [[Arg1.x, Arg1.y]])); return {x:result[0][0], y:result[0][1]} };
