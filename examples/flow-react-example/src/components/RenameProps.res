...
type functionTypeWithGenTypeAs = (
  @genType.as("type") ~type_: string,
  @genType.as("$number") ~number: int,
) => int
...
@genType
let padding3 = (pad1, pad2, @genType.as("xRenamed") ~x) => pad1 + pad2 + x

@genType
let renameABunch = (
  pad,
  @genType.as("xRenamed") ~x,
  @genType.as("yRenamed") ~y,
  @genType.as("zRenamed") ~z,
) => pad + x + y + z

@genType
let renameABunch2 = (pad, @genType.as("xRenamed") ~x, ~y, @genType.as("zRenamed") ~z) =>
  pad + x + y + z
