...
export const actionToString: (action) => string = function _(Arg1) { const result = VariantsBS.actionToString((typeof(Arg1) === 'object' ? (Arg1.tag==="AdjustAge" ? CreateBucklescriptBlock.__(0, [Arg1.value]) :  Arg1.tag==="Booly" ? CreateBucklescriptBlock.__(1, [Arg1.value]) :  Arg1.tag==="OptionalInt" ? CreateBucklescriptBlock.__(2, [(Arg1.value == null ? undefined : Arg1.value)]) :  Arg1.tag==="Unity" ? CreateBucklescriptBlock.__(3, [Arg1.value]) :  Arg1.tag==="OptionalBooly" ? CreateBucklescriptBlock.__(4, [(Arg1.value == null ? undefined : Arg1.value)]) :  CreateBucklescriptBlock.__(5, [function _(Arg11) { const result1 = Arg1.value(Arg11); return (result1 == null ? undefined : result1) }])) : $$toRE102731832[Arg1])); return result };
