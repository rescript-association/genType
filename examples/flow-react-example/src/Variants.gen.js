...
export const actionToString: (action) => string = function _(Arg1) { const result = VariantsBS.actionToString((typeof(Arg1) === 'object' ? (Arg1.tag==="AdjustAge" ? [/* 0 */48, Arg1.value] :  Arg1.tag==="Booly" ? [/* 1 */49, Arg1.value] :  Arg1.tag==="OptionalInt" ? [/* 2 */50, [(Arg1.value[0] == null ? undefined : Arg1.value[0])]] :  Arg1.tag==="Unity" ? [/* 3 */51, Arg1.value] :  Arg1.tag==="OptionalBooly" ? [/* 4 */52, [(Arg1.value[0] == null ? undefined : Arg1.value[0])]] :  [/* 5 */53, [function _(Arg11) { const result1 = Arg1.value[0](Arg11); return (result1 == null ? undefined : result1) }]]) : YY[Arg1])); return result };
