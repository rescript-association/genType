...
function token(lexbuf) {
  lexbuf.lex_mem = Caml_array.caml_make_vect(10, -1);
  var lexbuf$1 = lexbuf;
  ...
  while(true) {
    ...
    switch (__ocaml_lex_state$1) {
      ...
      case 15 :
          var lit = Lexing.sub_lexeme(lexbuf$1, lexbuf$1.lex_start_pos, lexbuf$1.lex_curr_pos - 1 | 0);
          var modif = Lexing.sub_lexeme_char(lexbuf$1, lexbuf$1.lex_curr_pos - 1 | 0);
          return /* INT */Block.__(8, [/* tuple */[
                      lit,
                      modif
                    ]]);
      ...
      case 17 :
          var lit$1 = Lexing.sub_lexeme(lexbuf$1, lexbuf$1.lex_start_pos, lexbuf$1.lex_curr_pos - 1 | 0);
          var modif$1 = Lexing.sub_lexeme_char(lexbuf$1, lexbuf$1.lex_curr_pos - 1 | 0);
          return /* FLOAT */Block.__(1, [/* tuple */[
                      lit$1,
                      modif$1
                    ]]);
      ...
      case 19 :
          ...
          string_start_loc.contents = $$Location.curr(lexbuf$1);
          string(lexbuf$1);
      ...
      case 30 :
          var stars = Lexing.sub_lexeme(lexbuf$1, lexbuf$1.lex_start_pos + 3 | 0, lexbuf$1.lex_curr_pos);
      ...
      case 32 :
          var stars$1 = Lexing.sub_lexeme(lexbuf$1, lexbuf$1.lex_start_pos + 2 | 0, lexbuf$1.lex_curr_pos - 2 | 0);
          if (handle_docstrings.contents && stars$1 === "") {
      ...
      case 34 :
          ...
          var name = Lexing.sub_lexeme_opt(lexbuf$1, Caml_array.caml_array_get(lexbuf$1.lex_mem, 4), Caml_array.caml_array_get(lexbuf$1.lex_mem, 3));
          var directive = Lexing.sub_lexeme(lexbuf$1, lexbuf$1.lex_start_pos, Caml_array.caml_array_get(lexbuf$1.lex_mem, 2));
          var line_num;
          try {
      ...
      case 46 :
          return /* DOTDOT */21;
      case 47 :
          var s$2 = Lexing.sub_lexeme(lexbuf$1, lexbuf$1.lex_start_pos + 1 | 0, lexbuf$1.lex_curr_pos);
...
function __ocaml_lex_comment_rec(lexbuf, ___ocaml_lex_state) {
  while(true) {
    ...
    switch (__ocaml_lex_state$1) {
      ...
      case 2 :
          string_start_loc.contents = $$Location.curr(lexbuf);
