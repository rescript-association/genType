...
var standard_library_default = "/Users/cristianoc/reasonml/bucklescript/native/4.06.1/lib/ocaml";
...
var standard_runtime = "/Users/cristianoc/reasonml/bucklescript/native/4.06.1/bin/ocamlrun";
...
var ocamlc_cppflags = "-D_FILE_OFFSET_BITS=64";

var ocamlopt_cflags = "-O2 -fno-strict-aliasing -fwrapv";

var ocamlopt_cppflags = "-D_FILE_OFFSET_BITS=64";

var bytecomp_c_libraries = "";

var bytecomp_c_compiler = "gcc -O2 -fno-strict-aliasing -fwrapv  -D_FILE_OFFSET_BITS=64";

var native_c_compiler = "gcc -O2 -fno-strict-aliasing -fwrapv -D_FILE_OFFSET_BITS=64";
...
match = /* tuple */[
  ...
  "gcc -O2 -fno-strict-aliasing -fwrapv -Wall -D_FILE_OFFSET_BITS=64 -DCAML_NAME_SPACE   -Wl,-no_compact_unwind",
  "gcc -shared -flat_namespace -undefined suppress                    -Wl,-no_compact_unwind"
];
...
var host = "x86_64-apple-darwin19.0.0";

var target = "x86_64-apple-darwin19.0.0";
...
function print_config(oc) {
  ...
  p_bool("systhread_supported", false);
  p("host", host);
  p("target", target);
